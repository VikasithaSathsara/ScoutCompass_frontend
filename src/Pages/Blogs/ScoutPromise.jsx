                ...
                <div class="facts">
                    ...
                    <div className="blog1">
                        ...
                        <p className="blog1_para">
                            On my honour, I promise to do my best To do my duty
                            to my religion and country To help other people at
                            all times To obey the Scout law.
                            <br />
                        </p>
                        <h2 class="topic-main">බාලදක්‍ෂ පොරොන්දුව.</h2>
                        <p className="blog1_para">
                            මාගේ ආගම හා රට කෙරෙහි යුතුකම් ඉටු කිරීමට ද, සෑම
                            කල්හිම අනුන්ට උපකාර කිරීමට ද, බාලදක්ෂ නීතියට කීකරු
                            වීමට ද, මාගේ අවංක විශ්වාසය උඩ මාෙග් සම්පූර්ණ උත්සාහය
                            යෙදීමට ගෞරව බහුමානයෙන් යුතුව පොරොන්දු වෙමි.
                        </p>
                    </div>
                    <br />
                    <div
