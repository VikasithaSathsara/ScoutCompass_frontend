            ...
            <div class="blog_content_container">
                <div class="facts">
                    ...
                    <div className="blog2">
                        ...
                        Scouts wear a uniform during their weekly meetings and sometimes 
                        on trips away, depending on where they're going and what they're 
                        doing. Usually, this consists of a teal green shirt or blouse with 
                        their badges sewn on, which they pair with a scarf, known as a necker. 
                        Exact uniforms will vary slightly if your Troop is part of the Air 
                        Scouts or Sea Scouts. <br /><br /> 

                        Alongside their shirts, Scouts might wear the accompanying blue uniform 
                        trousers or skirt, or they might save their uniform bottoms to wear for 
                        special occasions like awards ceremonies and public events – choosing to 
                        wear something more casual with their shirt during the week. Optional 
                        accessories such as hats, hoodies, are also available.</p>
                        <br />

                        <h2 class="topic-main">බාලදක්ෂ නිල ඇඳුම යනු කුමක්ද?</h2>
                        <p className="blog2_para">
                        බාලදක්ෂයින් ඔවුන්ගේ සතිපතා රැස්වීම් වලදී සහ සමහර විට ඔවුන් යන ස්ථානය සහ ඔවුන් 
                        කරන්නේ කුමක්ද යන්න මත පදනම්ව, නිළ ඇඳුමක් අඳිති. සාමාන්‍යයෙන්, මෙය සමන්විත 
                        වන්නේ ඔවුන්ගේ ලාංඡන මැසූ ටීල් කොළ පැහැති කමිසයකින් හෝ බ්ලවුසයකින් වන අතර, 
                        ඔවුන් බෙල්ලක් ලෙස හැඳින්වෙන ස්කාෆ් සමඟ යුගල කරයි. ඔබේ භට කණ්ඩායම ගුවන් 
                        බාලදක්ෂයින් හෝ මුහුදු බාලදක්ෂයින්ගේ කොටසක් නම් නිවැරදි නිල ඇඳුම් තරමක් වෙනස් වනු ඇත. <br /><br /> 

                        ඔවුන්ගේ කමිසයට අමතරව, බාලදක්ෂයින් නිල් නිල ඇඳුමේ කලිසම හෝ සායක් පැළඳිය හැකිය, 
                        නැතහොත් සම්මාන උත්සව සහ පොදු උත්සව වැනි විශේෂ අවස්ථා සඳහා ඇඳීමට ඔවුන්ගේ නිල 
                        ඇඳුමේ යට ඉතිරි කර ගත හැකිය - සතිය තුළ ඔවුන්ගේ කමිසය සමඟ වඩාත් අනියම් දෙයක් 
