...
function ScoutDetailsView() {
  ...
  const handleSubmit = async () => {
    fetch(
      `http://localhost:8081/api/scoutcompass/requirement/status/updateStatus`,
      {
        method: "POST",
        headers: {
              ...
              <tr>
                ...
                <td>
                  <div>
                    ...
                    <label
                      ...
                      onClick={() =>
                        handleRequirementButtonClick(item.scoutEmail)
                      }
                    >
                      View Requirements
                    </label>
                ...
                <td>
                  <div>
                    ...
                    />
                    <label
                      onClick={() => handleProfileButtonClick(item.scoutEmail)}
                      ...
                      <div className="modal-wrap">
                        ...
                        <table className="profileview-table">
                          <tbody>
                            ...
                            <tr className="profileview-tr">
                              <td className="profileview-td">Date Of Birth</td>
                              <td className="profileview-td">:</td>
                              <td>{userData?.dob}</td>
                            </tr>
                            <tr className="profileview-tr">
                            ...
                            <tr className="profileview-tr">
                              <td className="profileview-td">Contact Number</td>
                              <td className="profileview-td">:</td>
