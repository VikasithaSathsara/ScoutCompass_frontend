    ...
    <div className="bg_profile">
      ...
      <div class="main-bd">
        <div class="left-side">
          ...
          >
            <div className={`main5 ${isInstructor ? "instructor-main5" : ""}`}>
              <h2
                className={`ins_h2 ${isInstructor ? "instructor-ins_h2" : ""}`}
              >
                Personal Details
              </h2>
              <div
                className={`card5 ${isInstructor ? "instructor-card5" : ""}`}
              >
                <div
                  className={`card-body5 ${
                    isInstructor ? "instructor-card-body5" : ""
                  }`}
                >
                  <table
                    className={`table5 ${
                      isInstructor ? "instructor-table5" : ""
                    }`}
                  >
                    <tbody>
                      <tr>
            ...
            <div class="nav">
              <ul>
                <li
                  ...
                  className={`user-post ${currentTab === 0 ? "active" : ""}`}
                >
                ...
                <div id="wrapper5">
                  <div id="labels">
                    <ul>
                      ...
                      <li>
                        <span></span>Chief Commissioner Award
                      </li>

                      <li>
                        <span></span>Prime Minister Award
                      </li>
                    </ul>
                  </div>
