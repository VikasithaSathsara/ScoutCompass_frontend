      ...
      <ChakraProvider>
        ...
        <div class="hm_content">
          <div class="hm_card">
            ...
            <p class="hm_text">Click to see or edit your profile page.</p>
          </div>
          ...
          <div class="hm_card">
            ...
            <p class="hm_text">Check all your favourites in one place.</p>
          </div>
          ...
          <div class="hm_card">
            ...
            <p class="hm_text">Add or change your contacts and links.</p>
          </div>
          <a href="/mcq">
            <div class="hm_card">
              <div class="hm_icon">
              ...
              <p class="hm_text">Enhance your scouting knowledge</p>
            </div>
          </a>
        </div>
        ...
        <div className="simple-bar-chart">
          {data.map((item, index) => (
            <div
              key={index}
              className="item"
              style={{ "--clr": item.color, "--val": item.value }}
            >
